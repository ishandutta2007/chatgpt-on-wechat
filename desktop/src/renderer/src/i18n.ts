const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    config_max_tokens_hint: '手动覆盖上下文输入预算；留空或填 0 则按当前模型的上下文窗口自动计算',
  ...
  en: {
    ...
    config_max_tokens_hint: 'Manually override the context input budget; leave empty or 0 to derive it from the current model\u2019s context window',
